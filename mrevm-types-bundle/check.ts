...
// import {  mrevmDefinitions_old } from "./index_old";
...
// compare(
//    mrevmDefinitions_old.types ?  mrevmDefinitions_old.types[6].types : {},
//    mrevmDefinitions_old.types ?  mrevmDefinitions_old.types[7].types : {}
// );
// compare(
//    mrevmDefinitions.types ?  mrevmDefinitions.types[7].types : {},
//    mrevmDefinitions_old.types ?  mrevmDefinitions_old.types[7].types : {}
// );
...
//   deepEqual(
//      mrevmDefinitions.types ?  mrevmDefinitions.types[i].types : {},
//      mrevmDefinitions_old.types ?  mrevmDefinitions_old.types[i].types : {}
//   );
// });
