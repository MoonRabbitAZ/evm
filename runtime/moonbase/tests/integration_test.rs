...
fn verify_pallet_prefixes() {
	...
	is_pallet_prefix::<moonbase_runtime::JurisdictionSystem>("JurisdictionSystem");
	is_pallet_prefix::<moonbase_runtime::TransactionPayment>("TransactionPayment");
	is_pallet_prefix::<moonbase_runtime::JurisdictionInfo>("JurisdictionInfo");
	...
	is_pallet_prefix::<moonbase_runtime::JurisdictionStaking>("JurisdictionStaking");
...
fn verify_pallet_indices() {
	...
	is_pallet_index::<moonbase_runtime::JurisdictionSystem>(6);
	is_pallet_index::<moonbase_runtime::TransactionPayment>(7);
	is_pallet_index::<moonbase_runtime::JurisdictionInfo>(8);
	...
	is_pallet_index::<moonbase_runtime::JurisdictionStaking>(12);
